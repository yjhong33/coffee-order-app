  ...
  return (
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 15, animation: 'cc-fade .5s ease' }}>
        ...
        <div style={{ fontSize: 25, fontWeight: 800, color: '#fff', letterSpacing: '-.6px' }}>CallCoffee</div>
        <div style={{ fontSize: 13, color: 'rgba(255,255,255,.72)', letterSpacing: '-.2px' }}>커피 주문, 한 번에 모아서</div>
      </div>
